...
def compare_test_runs(
    ...
    for run in runs:
        ...
        if run.brandbook_compliance:
            compliance = run.brandbook_compliance
            if compliance.overall_verdict == "non_compliant":
                penalty += 2.0
            elif compliance.overall_verdict == "needs_revision":
                penalty += 1.0
            penalty += (10.0 - compliance.compliance_score) * 0.3
