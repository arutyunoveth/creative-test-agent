...
ANALYSIS_PROMPT_RU = """Вы — бренд-стратег и креативный директор. Проанализируйте этот брендбук и дайте структурированное экспертное заключение.

ВАЖНО: Отвечайте ИСКЛЮЧИТЕЛЬНО на русском языке (кириллица). НЕ используйте украинский язык. Никаких украинских слов или форм. Только русский язык.
